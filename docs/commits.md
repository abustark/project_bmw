...
|---|---|---|
| 2.0.18 | *(this commit)* | Registry B-05 — `ecom-react` Vercel project fixed via API (removed CLI-default SSO wall, set `framework=nextjs`): React twin now live at `ecom-react-self.vercel.app`, all routes 200 + footer CTAs verified |
