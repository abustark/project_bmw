...
export const MOSAIC = ['shadcn-buttons', 'css-loaders', 'uiverse-glow', 'daisy-toggle', 'radix-tabs', 'lucide-draw']

// Curated shop tag filters
export const SHOP_TAGS = ['MIT', 'ISC', 'Free', 'CSS', 'Tailwind', 'React', 'SVG', 'Lottie', 'Motion', 'Landing']
...
let installed = false
export function installPreviewStyles() {
